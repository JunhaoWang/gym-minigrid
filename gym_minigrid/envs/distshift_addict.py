...
class DistShiftAddict2Env(MiniGridEnv):
    """
    Distributional shift environment.
    """
...
class DistShiftAddict3(DistShiftAddict2Env):
    def __init__(self):
        super().__init__(strip2_row=2)
...
register(
    id='MiniGrid-DistShiftAddict3-v0',
    entry_point='gym_minigrid.envs:DistShiftAddict3'
)
